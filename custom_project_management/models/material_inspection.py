                ...
                for user in self.tower_id.assigned_to_ids:
                    ...
                    for group in groups:
                        ...
                        if str(group.name) == 'Checker':
                            ...
                            message = "CheckList No " + str(self.project_info_id.name) + "/" + str(self.tower_id.name) + "/" + str(self.date_of_insp.strftime('%B')) + "/" + str(self.mir_no) + " Submitted by " + str(user_record.name)
                    ...
                    for user in self.tower_id.assigned_to_ids:
                        ...
                        for group in groups:
                            ...
                            if str(group.name) == 'Maker':
                                ...
                                message = "CheckList No: " + str(self.project_info_id.name) + "/" + str(self.tower_id.name) + "/" + str(self.date_of_insp.strftime('%B')) + "/" + str(self.mir_no) + " Rejected by " + str(user_record.name)
